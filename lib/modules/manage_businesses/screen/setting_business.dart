...
import 'package:chonburi_mobileapp/modules/manage_businesses/screen/edit_business.dart';
...
class _SettingBusinessState extends State<SettingBusiness> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<BusinessesBloc, BusinessesState>(
      builder: (context, state) {
        return Scaffold(
          appBar: AppBar(
            toolbarHeight: height * 0.13,
            automaticallyImplyLeading: false,
            title: buildHeader(width, state.businessModel.businessName),
