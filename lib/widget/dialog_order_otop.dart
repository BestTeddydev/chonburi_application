...
dialogConfirmChangeStatus(
    BuildContext context, OrderOtopModel order, String token, onSubmit) {
  showDialog(
    context: context,
...
dialogConfirmBuyerChangeStatus(BuildContext context, OrderOtopModel order,
    String token, File image, onSubmit) {
  showDialog(
    context: context,
    builder: (context) => SimpleDialog(
      backgroundColor: AppConstant.bgAlert,
      title: ListTile(
        ...
        subtitle: const Center(
          child: TextCustom(
            title: 'คุณยืนยันที่จะแนบการชำระเงินใช่หรือไม่',
          ),
        ),
      ),
      children: <Widget>[
